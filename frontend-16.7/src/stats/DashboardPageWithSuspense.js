...
const LogsResource = unstable_createResource(() => demo_delayFetch(() => loadDataFromApi("/logs"), 1000));
const UsersResource = unstable_createResource(() => demo_delayFetch(() => loadDataFromApi("/users"), 2000));
